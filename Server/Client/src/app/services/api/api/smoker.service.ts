...
import { MeasurementClient } from '../model/measurementClient';
...
export class SmokerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public smokerLatestGet(observe?: 'body', reportProgress?: boolean): Observable<MeasurementClient>;
    public smokerLatestGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MeasurementClient>>;
    public smokerLatestGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MeasurementClient>>;
    public smokerLatestGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<MeasurementClient>('get',`${this.basePath}/Smoker/latest`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
