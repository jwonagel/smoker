...
domains=(roadchiefs.ddns.net)
rsa_key_size=4096
data_path="./data/certbot"
email="jwo.nagel@gmail.com" # Adding a valid address is strongly recommended
echo $email
...
echo '### Change permission of directories ###'
sudo chmod u=rwx,o=rwx -R "$data_path/conf/archive"
...
sudo chmod u=rwx,o=rwx data/certbot/conf/live/roadchiefs.ddns.net/certificate.pfx 
